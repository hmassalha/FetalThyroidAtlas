...
We also provide a set of helper functions that are called across all `.py` or `.ipynb` files, along with the colour definitions used for the different clusters throughout the analysis. These shared utilities are collected in the *snippet_and_more* folder.
