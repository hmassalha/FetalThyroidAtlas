...
data_dir = 'Data/adata_imm_all_T21_2n_harm_anno'
design_formula = '~ 0 + karyotype + age_group'


outDir = file.path('Results/2505/T21vs2n_immune_differentialAbundance/milo_analysis',object_type)
if(!dir.exists(outDir)){
...
data_dir = 'Data/adata_imm_all_2n_harm_anno'
design_formula = '~ 0 + age_group + donor'


outDir = file.path('Results/2505/2n_immune_differentialAbundance/milo_analysis',object_type)
if(!dir.exists(outDir)){
  dir.create(outDir,recursive = T)
}
